...
% Last Modified by GUIDE v2.5 06-Jul-2017 14:11:33
...
%               text17: [1x1 UIControl]
%      RFphaseangleval: [1x1 UIControl]
...
% RF phase angle
phaseAngle = str2double(get(handles.RFphaseangleval, 'String')) * pi / 180;
...
function RFphaseangleval_Callback(hObject, eventdata, handles)
% hObject    handle to RFphaseangleval (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of RFphaseangleval as text
%        str2double(get(hObject,'String')) returns contents of RFphaseangleval as a double


% --- Executes during object creation, after setting all properties.
function RFphaseangleval_CreateFcn(hObject, eventdata, handles)
% hObject    handle to RFphaseangleval (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
